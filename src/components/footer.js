  ...
  return (
    <div className="w-full">
      ...
      <footer class="bg-gray">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 max-width ">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
              <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                  ...
                  <li>
                    <a href="https://tailwindcss.com/" class="hover:underline">Service</a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul class="text-gray-500 dark:text-gray-400 font-medium">
                  ...
                  <li class="mb-3">
                    <a href="#" class="hover:underline">+000 0000 000</a>
                  </li>
                  <li>
                    <a href="#" class="hover:underline">Fareej Kulaib, Bin Omar, Doha, Qatar. P.O Box : 16128</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="card-media-mark xsm:mt-0 mt-4">
